package me.rhunk.abdooenhance.core.bridge
...
import me.rhunk.abdooenhance.bridge.AccountStorage
import me.rhunk.abdooenhance.bridge.BridgeInterface
import me.rhunk.abdooenhance.bridge.ConfigStateListener
import me.rhunk.abdooenhance.bridge.DownloadCallback
import me.rhunk.abdooenhance.bridge.SyncCallback
import me.rhunk.abdooenhance.bridge.e2ee.E2eeInterface
import me.rhunk.abdooenhance.bridge.logger.LoggerInterface
import me.rhunk.abdooenhance.bridge.logger.TrackerInterface
import me.rhunk.abdooenhance.bridge.scripting.IScripting
import me.rhunk.abdooenhance.bridge.snapclient.MessagingBridge
import me.rhunk.abdooenhance.common.Constants
import me.rhunk.abdooenhance.common.bridge.FileLoaderWrapper
import me.rhunk.abdooenhance.common.bridge.types.BridgeFileType
import me.rhunk.abdooenhance.common.bridge.types.FileActionType
import me.rhunk.abdooenhance.common.bridge.types.LocalePair
import me.rhunk.abdooenhance.common.data.MessagingFriendInfo
import me.rhunk.abdooenhance.common.data.MessagingGroupInfo
        ...
        with(context.androidContext) {
            runCatching {
                startActivity(Intent()
                    .setClassName(Constants.SE_PACKAGE_NAME, "me.rhunk.abdooenhance.bridge.ForceStartActivity")
            ...
            runCatching {
                val intent = Intent()
                    .setClassName(Constants.SE_PACKAGE_NAME,"me.rhunk.abdooenhance.bridge.BridgeService")
